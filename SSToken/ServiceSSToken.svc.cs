...
namespace SSToken
{
    ...
    public class ServiceSSToken : /*IServiceToken,*/ IServiceGestion, IServiceAcceso
    {
        ...
        public IEnumerable<VMRol> ObtenerRoles()
        {
            try
            {
                return new NegocioUsuario().ObtenerRoles();
            }
            catch (Exception ex)
            {
                ExceptionService exception = new ExceptionService()
        ...
        public List<VMModulo> ObtenerModulosSistemaApp(int idSistema)
        {
            ...
            return new NegocioModulosAcceso()
                .ObtenerModulosSistemaApp(idSistema); 
        }
        ...
        public IEnumerable<VMPermisoItem> ObtenerPermisosItemsUsuario(string usuario)
        {
            try
            {
                return new NegocioSistema().ObtenerPermisosItemsUsuario(usuario);
            }
            catch (Exception ex)
            {
                ExceptionService exception = new ExceptionService()

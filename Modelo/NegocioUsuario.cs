...
namespace Modelo
{
    public class NegocioUsuario
    {
        ...
        public List<VMRol> ObtenerRoles()
        {
            try
            {
                IDAORol iDaoRol = new DAORol();
                RespuestaBD resp = iDaoRol.ObtenerRoles(true);
                if (resp.EXISTE_ERROR)
                {
                    throw new Exception(resp.MENSAJE);
                }
        ...
        public List<VMRol> ObtenerRolesUsuario(string usuario)
        {
            try
            {
                IDAORol iDaoRol = new DAORol();
                RespuestaBD resp = iDaoRol.ObtenerRolesUsuario(usuario);
                if (resp.EXISTE_ERROR)
                {
                    throw new Exception(resp.MENSAJE);
                }
